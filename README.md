...
- 🎯 Entry points to execute your program using `python -m <evo_science>` or `$ evo_science` with basic CLI argument parsing.
...
```bash
pip install evo_science
```

## Usage

```py
from evo_science import BaseClass
from evo_science import base_function
